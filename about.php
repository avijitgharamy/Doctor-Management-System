                        ...
                        <div class="text-sec padding-right-0">
                            ...
                            <ul class="row">
                              <li class="col-sm-6">
                                ...
                                <p>DAS provide reliable communications and improve public safety areas. </p>
                              </li>
                              <li class="col-sm-6">
                                <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                                <p>Doctor Appointment System has licensed and qualified doctors! </p>
                              </li>
                              <li class="col-sm-6">
                              ...
                              <li class="col-sm-6">
                                ...
                                <p>DAS qualified doctors offers free counseling to their patients. </p>
                              </li>
                            </ul>
                        </div>
                    </div>
